...
from utils.dataset_utils import check, mm_save_file, mm_separate_data, mm_split_data
...
def generate_food101(dir_path, num_clients, niid, balance, partition):
    ...
    mm_save_file(config_saving_path, train_saving_path, test_saving_path, train_data, test_data, num_clients,
